...
<span style="color:red"><b>NOTE : Change the <Attacker's Doamin> with your own domain in the v2 script . Also you need to create the DKIM , DMARC and SPF records in your own DNS server to avoid email delivery fail. Generate DKIM private and Public key using the OpenSSL</b></span>
